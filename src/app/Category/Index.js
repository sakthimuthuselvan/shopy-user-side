...
const Index = ({ categoryList }) => {
  ...
  return (
    <div className='mt-3'>
      <Typography variant='subtitle1' className='fw-bold pt-3 pb-2'>Explore By Categories</Typography>
          ...
          {overallCategory.map((item) => {
            return (
              <div onClick={() => categorySelectFun(item)} className='category col-lg-2 col-md-3 col-sm-4 col-4 mb-2 pointer'>
                ...
                <div>
                  <Typography variant='subtitle2' className='text-center fw-bold mt-2'>{item.name}</Typography>
                </div>
              </div>
